...
![Binary data sitribution of files.ibd 2048 pixels wide in 'ascii' mode: The color of each pixel represents the "printability" of each sample in a linear way. Black represents a null byte (00), white represents a set byte (FF), blue represents printable characters and red represents any other value.](assets/files-ascii-w2048.png)

In the above image, the color of each pixel represents the "printability" of each sample in a linear way: black represents a null byte (00), white represents a set byte (FF), blue represents printable characters and red represents any other value.
